...
def run(cfg, burst=None, save_in_scratch=False):
    ...
    for burst in bursts:
        ...
        topo_output = {
            file_name_x: (rdr2geo_cfg.compute_longitude, gdal.GDT_Float64),
            ...
            file_name_los_east: (
                rdr2geo_cfg.compute_ground_to_sat_east,
                gdal.GDT_Float32,
            ),
            file_name_los_north: (
                rdr2geo_cfg.compute_ground_to_sat_north,
                gdal.GDT_Float32,
            ),
        }
        raster_list = [
