...
def compute_geocoding_correction_luts(burst, dem_path,
    ...
    rg_set_2 = resize(rg_set_temp_2, out_shape, **kwargs)
    az_set_2 = resize(az_set_temp_2, out_shape, **kwargs)

    rg_set_3 = resize(rg_set_temp_3, out_shape, **kwargs)
    az_set_3 = resize(az_set_temp_3, out_shape, **kwargs)
